...
export class Pivot extends React.Component {
		...
		webdatarocks;
            ...
            //     global: React.object,
            //     width: [React.string, React.number],
            //     height: [React.string, React.number],
            //     report: [React.string, React.object],
            //     toolbar: React.bool,
            //     customizeCell: React.func,
            //     cellclick: React.func,
            //     celldoubleclick: React.func,
            //     dataerror: React.func,
            //     datafilecancelled: React.func,
            //     dataloaded: React.func,
            //     datachanged: React.func,
            //     fieldslistclose: React.func,
            //     fieldslistopen: React.func,
            //     filteropen: React.func,
            //     fullscreen: React.func,
            //     loadingdata: React.func,
            //     loadinglocalization: React.func,
            //     loadingreportfile: React.func,
            //     localizationerror: React.func,
            //     localizationloaded: React.func,
            //     openingreportfile: React.func,
            //     querycomplete: React.func,
            //     queryerror: React.func,
            //     ready: React.func,
            //     reportchange: React.func,
            //     reportcomplete: React.func,
            //     reportfilecancelled: React.func,
            //     reportfileerror: React.func,
            //     reportfileloaded: React.func,
            //     runningquery: React.func,
            //     update: React.func,
            //     beforetoolbarcreated: React.func
            // }
